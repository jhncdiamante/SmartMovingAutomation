...
from src.CRM.SmartMoving.Pages.InsightsPage.BookOpportunitiesByServiceDate import BookOpportunitiesByServiceDate
...
class Insights(SmartMovingPage):
    def __init__(
        ...
        #booked_opportunities_by_service_date: BookOpportunitiesByServiceDate,
